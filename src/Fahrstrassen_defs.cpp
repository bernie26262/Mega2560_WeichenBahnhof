...
//
// Ziel dieser Datei:
// - alle Trigger-Sensoren zentral an EINER Stelle
// - alle Reset-Sensoren zentral an EINER Stelle
// - alle Weichen-Schaltfolgen zentral an EINER Stelle
// - jede Fahrstraße mit sprechendem Namen und Kommentaren
//
// Legende:
...
{
    {
        ...
        FS0_STEPS, (uint8_t)(sizeof(FS0_STEPS) / sizeof(FS0_STEPS[0]))
    },
    {
        "FS1 Folgefahrt ab S2",
        SENSOR_S2,
        { }, 0,
        FS1_STEPS, (uint8_t)(sizeof(FS1_STEPS) / sizeof(FS1_STEPS[0]))
    },
    {
        "FS2 Folgefahrt ab S4",
        SENSOR_S4,
        { }, 0,
        FS2_STEPS, (uint8_t)(sizeof(FS2_STEPS) / sizeof(FS2_STEPS[0]))
    },
    {
        "FS3 Folgefahrt ab S7",
        SENSOR_S7,
        { }, 0,
        FS3_STEPS, (uint8_t)(sizeof(FS3_STEPS) / sizeof(FS3_STEPS[0]))
    },
    {
        "FS4 Bahnhof Ost / W9 alternierend",
        SENSOR_S8,
        { SENSOR_S10 }, 1,
        FS4_STEPS, (uint8_t)(sizeof(FS4_STEPS) / sizeof(FS4_STEPS[0]))
    }
};